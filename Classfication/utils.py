...
def load_dataset(path,args):
    ...
    for line in lines:
        ...
        if args.prefix != "QA":
            ...
            sent = "Is the strategy " + args.strategy_type.replace("_", "-") + " used in the conversion from " + original + " to " + reframe + "?" 
            # sent = "Is " + args.strategy_type.lower() + "used in the conversion from " + original + " to " + reframe + "?" 
